  ...
  stages {
    ...
    stage("deploy") {
      steps {
        ...
        [applications: [[apiToken: 'd56b35a261c04c3982a17ed9086822c8', downloadAllowed: true, filePath: 'artifacts/', mandatory: true, notifyTeam: true, releaseNotesMethod: none(), uploadMethod: appCreation(false)]], debugMode: false, failGracefully: false]
